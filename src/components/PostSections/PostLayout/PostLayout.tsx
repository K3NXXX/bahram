...
export const PostLayout = () => {
    const popularPosts = useSelector((state:RootState) => state.postsSlice.popularPosts.items)
  return (
    <section className={style.root}>
        <div className={style.top}>
            <h3 className={style.title}>Popular</h3>
            <Link to={POPULAR_ROUTE} className={style.viewAll}>View All</Link>
        </div>
        <div className={style.content}>
            <div className={style.content__left}>
                <p className={style.author}>BY TOMAS LAURINAVICIUS IN FREELANCE</p>
