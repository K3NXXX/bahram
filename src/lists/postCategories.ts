...
import { ESSENTIALS_ROUTE, FREELANCE_ROUTE, HOW_NOT_TO_ROUTE, POPULAR_ROUTE, SEO_ROUTE, TYPOGRAPHY_ROUTE, UI_DESIGN_ROUTE, UX_DESIGN_ROUTE } from "../utils/consts"
...
export const postCategories:postCategoriesType[] = [
    ...
    },
    {
        id: 4,
        title: "Freelance",
        description: "From tools to tips, everything you need to start — or grow — your freelance design career.",
        image: freelance,
    ...
    },
    {
        id: 5,
        title: "SEO",
        description: "Everything you need to know to make sure your sites rank high in search.",
        image: seo,
        route: SEO_ROUTE
    },
    {
        id: 6,
        title: "Typography",
        description: "The web is 99% typography. Make sure you're setting your type right.",
        image: typography,
    ...
    },
    {
        id: 8,
        title: "How not to",
        description: "Like a serving of snark with your web design advice? Then you're going to love these.",
        image: howNotTo,
